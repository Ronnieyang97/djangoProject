...
var Select = (_Select = {
  ...
  getPlaceholderElement: function getPlaceholderElement() {
    ...
    if (value.length === 1 && state._value && !(0, _isValid.default)(state._value[0])) {
      hidden = false;
    }
  ...
  _getInputElement: function _getInputElement() {
    ...
    }, [(0, _vnode.cloneElement)(inputElement, _objectSpread(_objectSpread({
  ...
  renderFilterOptions: function renderFilterOptions() {
    ...
    if (tags) {
      ...
      value.forEach(function (singleValue) {
        ...
        var menuItem = (0, _vue.createVNode)(_vcMenu.Item, (0, _vue.mergeProps)(attrs, {
      ...
      if (type === null || type === void 0 ? void 0 : type.isSelectOptGroup) {
        ...
        if (inputValue && _this13._filterOption(inputValue, child)) {
          var innerItems = childChildren.map(function (subChild) {
            ...
            return (0, _vue.createVNode)(_vcMenu.Item, (0, _vue.mergeProps)(subChild.props, {
              "key": childValueSub,
              "value": childValueSub
            }), {
              default: function _default() {
          ...
          if (_innerItems.length) {
            sel.push((0, _vue.createVNode)(_vcMenu.ItemGroup, (0, _vue.mergeProps)(child.props, {
              "key": key,
              "title": label
            }), {
              default: function _default() {
  ...
  renderTopControlNode: function renderTopControlNode() {
    ...
    if ((0, _util.isSingleMode)(props)) {
      ...
      if (maxTagCount !== undefined && value.length > maxTagCount) {
        ...
        maxTagPlaceholderEl = (0, _vue.createVNode)("li", (0, _vue.mergeProps)(attrs, {
          "style": _util.UNSELECTABLE_STYLE,
          "onMousedown": _util.preventDefaultEvent,
      ...
      if ((0, _util.isMultipleOrTags)(props)) {
        selectedValueNodes = limitedCountValue.map(function (singleValue) {
          ...
          return (0, _vue.createVNode)("li", (0, _vue.mergeProps)(attrs, {
            "style": _util.UNSELECTABLE_STYLE,
            "onMousedown": _util.preventDefaultEvent,
  ...
  renderArrow: function renderArrow(multiple) {
    ...
    return (0, _vue.createVNode)("span", (0, _vue.mergeProps)(_util.UNSELECTABLE_ATTRIBUTE, {
      "key": "arrow",
  ...
  renderClear: function renderClear() {
    ...
    var clear = (0, _vue.createVNode)("span", (0, _vue.mergeProps)(_util.UNSELECTABLE_ATTRIBUTE, {
      "key": "clear",
