...
var _default2 = {
  ...
  props: {
    ...
    empty: _vueTypes.default.bool,
    options: _vueTypes.default.any,
    prefixCls: _vueTypes.default.string,
    popupClassName: _vueTypes.default.string,
    value: _vueTypes.default.array,
    // children: PropTypes.any,
    showAction: _vueTypes.default.arrayOf(_vueTypes.default.string),
    combobox: _vueTypes.default.bool,
  ...
  methods: {
    setDropdownWidth: function setDropdownWidth() {
      ...
      this.rafInstance = (0, _raf.default)(function () {
        ...
        var width = (_findDOMNode = (0, _propsUtil.findDOMNode)(_this3)) === null || _findDOMNode === void 0 ? void 0 : _findDOMNode.offsetWidth;
    ...
    getDropdownElement: function getDropdownElement(newProps) {
      ...
      var dropdownRender = props.dropdownRender,
          ariaId = props.ariaId;
      var menuNode = (0, _vue.createVNode)(_DropdownMenu.default, (0, _vue.mergeProps)(newProps, {
  ...
  render: function render() {
    ...
    return (0, _vue.createVNode)(_vcTrigger.default, (0, _vue.mergeProps)(props, {
      ...
      default: function _default() {
        return [(0, _propsUtil.getSlot)(_this4)[0]];
      }
    });
  }
};
