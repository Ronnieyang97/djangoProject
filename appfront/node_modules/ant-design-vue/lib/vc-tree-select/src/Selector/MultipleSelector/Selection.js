...
var Selection = {
  ...
  render: function render() {
    ...
    return (0, _vue.createVNode)("li", (0, _vue.mergeProps)(_util.UNSELECTABLE_ATTRIBUTE, {
      "style": _objectSpread(_objectSpread({}, _util.UNSELECTABLE_STYLE), style),
      "role": "menuitem",
      "class": (0, _classNames.default)("".concat(prefixCls, "-selection__choice"), className),
      "title": (0, _util.toTitle)(label)
    }), [onRemove && (0, _vue.createVNode)("span", {
      "class": "".concat(prefixCls, "-selection__choice__remove"),
      "onClick": this.onRemove
    }, [(0, _propsUtil.getComponent)(this, 'removeIcon')]), (0, _vue.createVNode)("span", {
