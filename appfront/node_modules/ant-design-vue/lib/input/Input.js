...
var _syncWatch = _interopRequireDefault(require("../_util/syncWatch"));
...
var _default = {
  name: 'AInput',
  inheritAttrs: false,
  props: _objectSpread({}, _inputProps.default),
  ...
  watch: {
    value: (0, _syncWatch.default)(function (val) {
      this.stateValue = val;
    })
  },
  ...
  methods: {
    ...
    renderInput: function renderInput(prefixCls, _ref) {
      ...
      var otherProps = (0, _omit.default)(this.$props, ['prefixCls', 'onPressEnter', 'addonBefore', 'addonAfter', 'prefix', 'suffix', 'allowClear', 'defaultValue', 'lazy', 'size', 'inputType', 'className', 'inputPrefixCls', 'loading']);
      ...
      return (0, _vue.createVNode)("input", inputProps, null);
    },
  ...
  render: function render() {
    ...
    var props = _objectSpread(_objectSpread(_objectSpread({}, this.$attrs), (0, _propsUtil.getOptionProps)(this)), {}, {
      prefixCls: prefixCls,
      inputType: 'input',
