...
var ListProps = function ListProps() {
  return {
    ...
    loading: _vueTypes.default.oneOfType([_vueTypes.default.bool, _vueTypes.default.object]),
    loadMore: _vueTypes.default.any,
    pagination: _vueTypes.default.oneOfType([_vueTypes.default.shape((0, _pagination.PaginationConfig)()).loose, _vueTypes.default.bool]),
    prefixCls: _vueTypes.default.string,
    rowKey: _vueTypes.default.any,
    renderItem: _vueTypes.default.any,
    size: _vueTypes.default.oneOf(ListSize),
    split: _vueTypes.default.bool,
...
var List = {
  ...
  render: function render() {
    ...
    var paginationProps = _objectSpread(_objectSpread({}, this.defaultPaginationProps), {}, {
    ...
    }, [(0, _vue.createVNode)(_pagination.default, _objectSpread(_objectSpread({}, (0, _omit.default)(restProps, ['onChange'])), {}, {
      class: cls,
      style: style,
    ...
    return (0, _vue.createVNode)("div", (0, _vue.mergeProps)(restAttrs, {
      "class": classString
