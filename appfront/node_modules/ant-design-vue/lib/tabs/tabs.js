...
var _default = {
  ...
  props: {
    ...
    hideAdd: _vueTypes.default.bool.def(false),
    tabBarStyle: _vueTypes.default.object,
    tabBarExtraContent: _vueTypes.default.any,
    destroyInactiveTabPane: _vueTypes.default.bool.def(false),
    ...
    onPrevClick: _vueTypes.default.func,
    onNextClick: _vueTypes.default.func,
    onEdit: _vueTypes.default.func,
  ...
  render: function render() {
    ...
    var tabsProps = _objectSpread(_objectSpread(_objectSpread({}, props), {}, {
      ...
      renderTabBar: function renderTabBar() {
        return (0, _vue.createVNode)(_TabBar.default, (0, _vue.mergeProps)(tabBarProps, {
          "key": "tabBar"
        }), null);
      },
