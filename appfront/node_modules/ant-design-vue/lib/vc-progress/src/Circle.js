...
var circlePropTypes = _objectSpread(_objectSpread({}, _types.propTypes), {}, {
  gapPosition: _vueTypes.default.oneOf(['top', 'bottom', 'left', 'right']),
  gapDegree: _vueTypes.default.oneOfType([_vueTypes.default.number, _vueTypes.default.string, _vueTypes.default.bool])
});

var circleDefaultProps = _objectSpread(_objectSpread({}, _types.defaultProps), {}, {
  gapPosition: 'top'
});
...
var Circle = {
  ...
  methods: {
    getStokeList: function getStokeList() {
      ...
      return percentList.map(function (ptg, index) {
        ...
        return (0, _vue.createVNode)("path", (0, _vue.mergeProps)(pathProps, {
          "ref": function ref(c) {
  ...
  render: function render() {
    ...
    return (0, _vue.createVNode)("svg", (0, _vue.mergeProps)(restProps, {
      "class": "".concat(prefixCls, "-circle"),
      "viewBox": "0 0 100 100"
    }), [gradient && (0, _vue.createVNode)("defs", null, [(0, _vue.createVNode)("linearGradient", {
