...
function createPicker(TheCalendar, props) {
  return {
    ...
    render: function render() {
      ...
      var props = (0, _omit.default)(_objectSpread(_objectSpread({}, (0, _propsUtil.getOptionProps)(this)), this.$attrs), ['onChange']);
      ...
      var calendar = (0, _vue.createVNode)(TheCalendar, theCalendarProps, _objectSpread({}, $slots));
      ...
      return (0, _vue.createVNode)("span", (0, _vue.mergeProps)((0, _util.getDataAndAriaProps)(this.$attrs), {
        "id": props.id,
      ...
      }), [(0, _vue.createVNode)(_Picker.default, vcDatePickerProps, _objectSpread({}, _objectSpread({
        default: input
      }, $slots)))]);
    }
  };
