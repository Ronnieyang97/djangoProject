...
var _default = {
  ...
  render: function render() {
    ...
    var _this$$attrs = this.$attrs,
        ...
        restProps = _objectWithoutProperties(_this$$attrs, ["class", "style", "onKeydown"]);
    ...
    if (extraContent) {
      newChildren = [(0, _vnode.cloneElement)(extraContent, {
        key: 'extra',
        style: _objectSpread({}, tabBarExtraContentStyle)
    ...
    return (0, _vue.createVNode)("div", (0, _vue.mergeProps)((0, _utils.getDataAttr)(restProps), {
      "role": "tablist",
      "class": cls,
      "tabindex": "0",
      "onKeydown": onKeyDown,
