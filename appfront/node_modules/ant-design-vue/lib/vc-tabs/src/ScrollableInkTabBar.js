  ...
  render: function render() {
    ...
    return (0, _vue.createVNode)(_SaveRef.default, {
      "children": function children(saveRef, getRef) {
        return (0, _vue.createVNode)(_TabBarRootNode.default, (0, _vue.mergeProps)(_this.$attrs, {
          "saveRef": saveRef
        }), {
          default: function _default() {
            return [(0, _vue.createVNode)(_ScrollableTabBarNode.default, (0, _vue.mergeProps)(_this.$attrs, {
              "saveRef": saveRef,
              "getRef": getRef
            }), {
              default: function _default() {
                return [(0, _vue.createVNode)(_TabBarTabsNode.default, (0, _vue.mergeProps)(_objectSpread(_objectSpread({}, _this.$attrs), {}, {
                  renderTabBarNode: renderTabBarNode
                }), {
                  "saveRef": saveRef
                }), null), (0, _vue.createVNode)(_InkTabBarNode.default, (0, _vue.mergeProps)(_this.$attrs, {
                  "saveRef": saveRef,
                  "getRef": getRef
                }), null)];
              }
