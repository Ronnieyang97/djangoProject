...
var ScrollableTabBar = function ScrollableTabBar(_, _ref) {
  ...
  return (0, _vue.createVNode)(_SaveRef.default, {
    "children": function children(saveRef, getRef) {
      return (0, _vue.createVNode)(_TabBarRootNode.default, (0, _vue.mergeProps)(attrs, {
        "saveRef": saveRef
      }), {
        default: function _default() {
          return [(0, _vue.createVNode)(_ScrollableTabBarNode.default, (0, _vue.mergeProps)(attrs, {
            "saveRef": saveRef,
            "getRef": getRef
          }), {
            default: function _default() {
              return [(0, _vue.createVNode)(_TabBarTabsNode.default, (0, _vue.mergeProps)(attrs, {
                "saveRef": saveRef
              }), null)];
            }
          })];
