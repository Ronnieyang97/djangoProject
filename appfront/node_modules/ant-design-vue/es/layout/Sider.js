...
import { initDefaultProps, getOptionProps, hasProp, getComponent, getSlot } from '../_util/props-util';
...
export default {
  ...
  render: function render() {
    ...
    var divProps = omit(others, ['collapsed', 'defaultCollapsed', 'onCollapse', 'breakpoint', 'onBreakpoint', 'siderHook', 'zeroWidthTriggerStyle', 'trigger', 'onUpdate:collapse']);
    ...
    return createVNode("aside", mergeProps(divProps, {
      "class": siderCls,
      "style": divStyle
    }), [createVNode("div", {
