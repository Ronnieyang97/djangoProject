...
var Selection = {
  ...
  render: function render() {
    ...
    return createVNode("li", mergeProps(UNSELECTABLE_ATTRIBUTE, {
      "style": _objectSpread(_objectSpread({}, UNSELECTABLE_STYLE), style),
      "role": "menuitem",
      "class": classNames("".concat(prefixCls, "-selection__choice"), className),
      "title": toTitle(label)
    }), [onRemove && createVNode("span", {
      "class": "".concat(prefixCls, "-selection__choice__remove"),
      "onClick": this.onRemove
    }, [getComponent(this, 'removeIcon')]), createVNode("span", {
