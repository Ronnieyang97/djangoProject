...
var CalendarFooter = {
  ...
  render: function render() {
    ...
    if (showToday || timePicker || extraFooter) {
      ...
      if (showToday) {
        nowEl = createVNode(TodayButton, mergeProps(btnProps, {
          "key": "todayButton"
        }), null);
      }
      ...
      if (showOk === true || showOk !== false && !!timePicker) {
        okBtn = createVNode(OkButton, mergeProps(btnProps, {
          "key": "okButton"
        }), null);
      }
      ...
      if (timePicker) {
        timePickerBtn = createVNode(TimePickerButton, mergeProps(btnProps, {
