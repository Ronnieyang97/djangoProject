...
var RangeCalendar = {
  ...
  render: function render() {
    ...
    if (showToday) {
      ...
      TodayButtonNode = createVNode(TodayButton, mergeProps(todayButtonProps, {
        "key": "todayButton"
      }), null);
    }
    ...
    if (props.timePicker) {
      ...
      TimePickerButtonNode = createVNode(TimePickerButton, mergeProps(timePickerButtonProps, {
    ...
    if (showOkButton) {
      ...
      OkButtonNode = createVNode(OkButton, mergeProps(okButtonProps, {
        "key": "okButtonNode"
      }), null);
    }
