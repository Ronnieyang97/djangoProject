...
export default {
  ...
  methods: {
    ...
    getDialogElement: function getDialogElement() {
      ...
      var dialogElement = withDirectives(createVNode(LazyRenderBox, {
        ...
        default: function _default() {
          ...
          }, [closer, header, createVNode("div", mergeProps(bodyProps, {
            "key": "body",
            "class": "".concat(prefixCls, "-body"),
            "style": bodyStyle,
            "ref": "body"
          }), [getSlot(_this4)]), footer]), createVNode("div", {
            "tabindex": 0,
            "ref": "sentinelEnd",
            "style": sentinelStyle,
            "aria-hidden": "true"
      ...
      return createVNode(Transition, mergeProps(dialogTransitionProps, {
        "key": "dialog"
      }), {
        default: function _default() {
    ...
    getMaskElement: function getMaskElement() {
      ...
      if (props.mask) {
        ...
        var tempMaskElement = withDirectives(createVNode(LazyRenderBox, mergeProps(props.maskProps || {}, {
        ...
        if (maskTransition) {
          ...
          maskElement = createVNode(Transition, mergeProps(maskTransitionProps, {
            "key": "mask"
          }), {
            default: function _default() {
  ...
  render: function render() {
    ...
    }, [this.getMaskElement(), createVNode("div", mergeProps(wrapProps, {
      "tabindex": -1,
