...
import { TransitionGroup, createVNode, mergeProps, createTextVNode } from "vue";
...
var Select = (_Select = {
  ...
  _getInputElement: function _getInputElement() {
    ...
    }, [cloneElement(inputElement, _objectSpread(_objectSpread({
  ...
  renderFilterOptions: function renderFilterOptions() {
    ...
    if (tags) {
      ...
      value.forEach(function (singleValue) {
        ...
        var menuItem = createVNode(MenuItem, mergeProps(attrs, {
      ...
      if (type === null || type === void 0 ? void 0 : type.isSelectOptGroup) {
        ...
        if (inputValue && _this13._filterOption(inputValue, child)) {
          var innerItems = childChildren.map(function (subChild) {
            ...
            return createVNode(MenuItem, mergeProps(subChild.props, {
              "key": childValueSub,
              "value": childValueSub
            }), {
              default: function _default() {
          ...
          if (_innerItems.length) {
            sel.push(createVNode(MenuItemGroup, mergeProps(child.props, {
              "key": key,
              "title": label
            }), {
              default: function _default() {
  ...
  renderTopControlNode: function renderTopControlNode() {
    ...
    if (isSingleMode(props)) {
      ...
      if (maxTagCount !== undefined && value.length > maxTagCount) {
        ...
        maxTagPlaceholderEl = createVNode("li", mergeProps(attrs, {
          "style": UNSELECTABLE_STYLE,
          "onMousedown": preventDefaultEvent,
      ...
      if (isMultipleOrTags(props)) {
        selectedValueNodes = limitedCountValue.map(function (singleValue) {
          ...
          return createVNode("li", mergeProps(attrs, {
            "style": UNSELECTABLE_STYLE,
            "onMousedown": preventDefaultEvent,
  ...
  renderArrow: function renderArrow(multiple) {
    ...
    return createVNode("span", mergeProps(UNSELECTABLE_ATTRIBUTE, {
      "key": "arrow",
  ...
  renderClear: function renderClear() {
    ...
    var clear = createVNode("span", mergeProps(UNSELECTABLE_ATTRIBUTE, {
      "key": "clear",
