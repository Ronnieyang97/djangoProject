import { inject, createVNode, resolveDirective, mergeProps } from "vue";
...
import { hasProp, getOptionProps, initDefaultProps, getComponent, isValidElement } from '../_util/props-util';
import { cloneElement } from '../_util/vnode';
import { formatDate } from './utils';
import { getDataAndAriaProps } from '../_util/util'; // export const PickerProps = {
//   value?: moment.Moment;
//   prefixCls: string;
// }
  ...
  return {
    ...
    render: function render() {
      ...
      var _this$$data = this.$data,
          ...
          open = _this$$data._open;
      var suffixIcon = getComponent(this, 'suffixIcon');
      suffixIcon = Array.isArray(suffixIcon) ? suffixIcon[0] : suffixIcon;
      var props = omit(_objectSpread(_objectSpread({}, getOptionProps(this)), this.$attrs), ['onChange']);
      ...
      var theCalendarProps = _objectSpread(_objectSpread({}, calendarProps), {}, {
      ...
      var vcDatePickerProps = _objectSpread(_objectSpread(_objectSpread({}, props), pickerProps), {}, {
        calendar: calendar,
        value: value,
      ...
      return createVNode("span", mergeProps(getDataAndAriaProps(this.$attrs), {
        "id": props.id,
        "class": classNames(props.class, props.pickerClass),
        "style": _objectSpread(_objectSpread({}, pickerStyle), props.style),
        "onMouseenter": this.onMouseEnter,
        "onMouseleave": this.onMouseLeave
      }), [createVNode(VcDatePicker, vcDatePickerProps, _objectSpread({}, _objectSpread({
        default: input
      }, $slots)))]);
    }
  };
