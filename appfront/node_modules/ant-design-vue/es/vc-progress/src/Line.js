...
var Line = {
  ...
  render: function render() {
    ...
    return createVNode("svg", mergeProps(restProps, {
      "class": "".concat(prefixCls, "-line"),
      "viewBox": viewBoxString,
      "preserveAspectRatio": "none"
    }), [createVNode("path", pathFirst, null), percentList.map(function (ptg, index) {
      var pathStyle = {
      ...
      return createVNode("path", mergeProps(pathProps, {
        "ref": function ref(c) {
